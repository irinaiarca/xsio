...
(function(/*! Stitch !*/) {
  ...
  (function() {
    (function() {
      ...
      __out.push('<button id="Story">Story</button>\n<button>Casual 1P</button>\n<button>Casual 2P</button>\n<button>Challenges</button>\n<button>Help</button>\n<a href="/login">LOGIN</a>\n<img src=""></img>\n');
