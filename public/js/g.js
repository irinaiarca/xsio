...
(function(/*! Stitch !*/) {
    ...
    function Application(message) {
      ...
      _login = function() {
        if (localStorage.getItem("login")) {
          return LinkManager.checkRoute("/index");
        }
        return document.getElementsByTagName("form")[0].addEventListener("submit", function(e) {
      ...
      routes = {
        ...
        "/story/pink/game": function() {
          document.body.innerHTML = "<section></section>";
          new (DepMan.helper("Runner"))(-1);
          return renderLogout();
        }
      };
      root.gButton = function(link, text, id, stilizat) {
        if (id == null) {
          id = "";
        }
        if (stilizat == null) {
  ...
  TableController = (function(_super) {
    ...
    function TableController() {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        kid = _ref[_i];
        kid.addEventListener("click", this.tick);
      }
    }
    ...
    TableController.prototype.done = function() {
      this.queue = [];
      return this.reset.apply(this, arguments);
    };

    TableController.prototype.player = function() {
  ...
  TableControllerErrorReporter = (function(_super) {
    ...
    TableControllerErrorReporter.extend(IS.ErrorReporter);

    return TableControllerErrorReporter;
...
}, "helpers/AI": function(exports, require, module) {(function() {
  var AI,
    __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  Runner = (function(_super) {
    ...
    Runner.prototype.lose = function() {
      return LinkManager.link("/story/" + (this.which()) + "/lose");
    };

    Runner.prototype.win = function() {
      console.log("" + (this.which()) + " Won");
      return LinkManager.link("/story/" + (this.which()) + "/win");
    };

    Runner.prototype.draw = function() {
      return LinkManager.link("/story/draw");
    };

    Runner.prototype.which = function() {
      if (this.character === 1) {
        return "blue";
      } else {
        return "pink";
...
if ( typeof define === "function" && define.amd && define.amd.jQuery ) {
...
}, "models/Enum": function(exports, require, module) {(function() {
  var Enum;
  ...
  ModelDeTable = (function(_super) {
    ...
    ModelDeTable.prototype.reset = function(success) {
      if (success == null) {
        success = false;
      }
    ...
    ModelDeTable.prototype.check = function() {
      ...
      for (_i = 0, _len = _solve.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = solution.length; _j < _len1; _j++) {
          x = solution[_j];
          if (_ref = !this.table[x], __indexOf.call([-1, 0, 1], _ref) >= 0) {
            throw ER.generate(3);
          }
        }
        if (this.table[solution[0]] === this.table[solution[1]] && this.table[solution[1]] === this.table[solution[2]] && ((_ref1 = this.table[solution[0]]) === (-1) || _ref1 === 1)) {
          return this.table[solution[0]];
        }
      }
      nr = 0;
      for (index = _k = 0; _k <= 8; index = ++_k) {
        if (this.table[index]) {
          nr++;
        }
      }
  ...
  ModelDeTableErrorReporter = (function(_super) {
    ...
    ModelDeTableErrorReporter.errors = {
      "TickError": ["Out of bounds", "Already ticked"],
      "CheckError": ["Wtf is this?"]
    };

    ModelDeTableErrorReporter.extend(IS.ErrorReporter);

    return ModelDeTableErrorReporter;
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/blue": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/blue/lose": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/blue/win": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/choice": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/draw": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/pink": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/pink/lose": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/story/pink/win": function(exports, require, module) {module.exports = function(__obj) {
  if (!__obj) __obj = {};
  var __out = [], __capture = function(callback) {
    var out = __out, result;
    __out = [];
  ...
  __obj.safe = __objSafe, __obj.escape = __escape;
  return __out.join('');
}}, "views/tabla": function(exports, require, module) {
...
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.unshift({ lineno: 4, filename: __jade[0].filename });
buf.push('<td id="spot0">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</td>');
__jade.shift();
__jade.unshift({ lineno: 5, filename: __jade[0].filename });
buf.push('<td id="spot1">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</td>');
__jade.shift();
__jade.unshift({ lineno: 6, filename: __jade[0].filename });
buf.push('<td id="spot2">');
__jade.unshift({ lineno: undefined, filename: __jade[0].filename });
__jade.shift();
buf.push('</td>');
__jade.shift();
